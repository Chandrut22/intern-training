...
class ChatService:
    ...
    async def get_chat_completion(self,
                                  ...
                                  max_token: int = settings.MAX_TOKEN) -> dict:
        ...
        try:
            ...
            logger.info(f"Chat completion succeeded with model")
    ...
    async def stream_chat_completion(
            ...
            try:
                    ...
                    async with client.stream(
                        ...
                        async for line in response.aiter_lines():
                            ...
                            try:
                                ...
                                logger.warning(
                                    f"Skipping malformed SSE chunk: {data!r}"
                                )
                                continue
                ...
                logger.warning(
                    f"OpenRouter failed with HTTP {status}"
                )
